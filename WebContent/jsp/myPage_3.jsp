    ...
    <div id="main" style="margin-left: 250px;">
        ...
        <!-- 콘텐츠 영역 -->
              ...
              <div class="table_layout">
                  <div class="buttons">
                    <button type="button" class="btn btn-secondary">내가 쓴 글 보기</button>
                    <button type="button" class="btn btn-secondary">내게 쓴 글 보기</button>
                    <button type="button" class="btn btn-secondary">질문 및 답변</button>
                  </div>
              </div>
                  <!-- //navigation-->
